...
interface UserApi {
    @GET("find/?user_id=0")
    suspend fun getAllUsers(): Response<FindUserResponseDto>

    @GET("find/?user_id={user_id}")
    suspend fun getUserById(@Path("user_id") id: String): Response<FindUserResponseDto>
    ...
    ): Response<LoginRegisterResponseDto>
